...
exports.handler = (event, context, callback) => {
    ...
    dynamo.query(user_param, function (err, data) {
        ...
        var id = currentId;
        var createdtime = event['body-json'].createdtime;
        var foldername = event['body-json'].foldername;
        var status = event['body-json'].status;
        var time = timestamp();
        var params = {
            TableName: tableName,
            Key: {
        ...
        params.UpdateExpression = "set #foldername = :f, #status = :s, #timestamp = :t";
